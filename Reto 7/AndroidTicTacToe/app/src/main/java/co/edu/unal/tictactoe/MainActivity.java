...
public class MainActivity extends AppCompatActivity {
            ...
            if (!mGameOver && mTurn && isChallengingPlayer != 2) {
                if (setMove(TicTacToeGame.HUMAN_PLAYER, pos)) {
                    ...
                    if (winner == 0) {
                        ...
                        //turnComputer();
                        mInfoTextView.setText("Opponent's turn");
                    } else {
                        endGame(winner);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String  challengingPlayer = getIntent().getStringExtra("challengerPlayer");
        ...
        if(StateChallengingPlayer.equals("0")) {
            ...
            mInfoTextView.setText("Oponent's turn");
            ...
            mInfoTextView.setText("Spectator mode \n X: "+defendingPlayer+", O: "+challengingPlayer);
            mTurn = false;
        }
