...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private class JsonTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(sumProduct <= 0 && sumArea <= 1){
                resultado.setText("No se encuentran datos para esta categoría");
            }else{
                resultado.setText("Cantidad de Producto: " + String.format("%.2f",sumProduct)  + " toneladas \nÁrea cosechada: " + String.format("%.2f",sumArea) + " hectareas\nRendimiento: " + String.format("%.2f",rendimiento) +" toneladas por hectarea");
            }
        }
    }
}